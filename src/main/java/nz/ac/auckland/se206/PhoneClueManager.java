...
public class PhoneClueManager {
  private ImageView imageView;

  private ScaleTransition scaleTransitionIn2;
  ...
  private ScaleTransition scaleTransitionOut2;
   ...
   * @param imageView
   */
  public PhoneClueManager(ImageView imageView) {
    ...
    scaleTransitionIn2 = new ScaleTransition(Duration.millis(100), imageView);
    scaleTransitionIn2.setFromX(1.0);
    scaleTransitionIn2.setFromY(1.0);
    scaleTransitionIn2.setToX(1.0);
    scaleTransitionIn2.setToY(1.0);
    scaleTransitionIn2.setCycleCount(1);
    ...
    scaleTransitionOut2 = new ScaleTransition(Duration.millis(100), imageView);
    scaleTransitionOut2.setFromX(1.0);
    scaleTransitionOut2.setFromY(1.0);
    scaleTransitionOut2.setToX(1.0);
    scaleTransitionOut2.setToY(1.0);
    scaleTransitionOut2.setCycleCount(1);
